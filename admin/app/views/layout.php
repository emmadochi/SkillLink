    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            <div class="logo-section">
                <img src="<?php echo asset_url('logo1.png'); ?>" alt="SkillLink Logo" class="brand-logo">
            ...
            <nav>
                <ul class="nav-links">
                    ...
                    <li>
                        <a href="<?php echo admin_url('user'); ?>" class="nav-link <?php echo ($active_section === 'user' || $active_section === 'users') ? 'active' : ''; ?>">
                    ...
                    <li>
                        <a href="<?php echo admin_url('booking'); ?>" class="nav-link <?php echo $active_section === 'booking' ? 'active' : ''; ?>">
                    ...
                    <li>
                        <a href="<?php echo admin_url('dispute'); ?>" class="nav-link <?php echo $active_section === 'dispute' ? 'active' : ''; ?>">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                            Disputes
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo admin_url('payment'); ?>" class="nav-link <?php echo $active_section === 'payment' ? 'active' : ''; ?>">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
                            Payments
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo admin_url('settings'); ?>" class="nav-link <?php echo $active_section === 'settings' ? 'active' : ''; ?>">
            ...
            <div class="sidebar-footer">
                <a href="<?php echo admin_url('logout'); ?>" class="nav-link" style="color: #ff8a8a;">
